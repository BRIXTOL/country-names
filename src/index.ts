import { CountryCodes, Country, ICountries, CountryName } from './types';
...
function getCountryName <
  ISO extends AnyCase<CountryCodes>
> (
...
export { ICountries, Countries, CountryCodes, getCountryName, Country };
